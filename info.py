...
# PyroClient Setup 
API_ID = int(environ['36123797'])
API_HASH = environ['25c2bbc7b080223a7ef8c877ac77a562']
BOT_TOKEN = environ['8205666666:AAEtVyqoECXQV3ZJix1JW1odg6Q6QG_3UhY']
...
CACHE_TIME = int(environ.get('6024198882', 300))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('1003436888701', '0').split()]
...
# MongoDB information
DATABASE_URL = environ.get('mongodb+srv://luckey028@luckey.xqhtrad.mongodb.net/?appName=luckey', "")
DATABASE_NAME = environ.get('luckey028, "Cluster0")
